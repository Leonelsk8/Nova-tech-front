    ...
    <>
       <section className="container-fluid footer">
        <div className="row mx-auto  mx-0 px-0">
          ...
          <article className="col-sm-12 col-md-4 mt-2 mb-1 text-center">
            <h5 >Información</h5>
            <Link className="nav-link icons" to="/E404">Preguntas frecuentes</Link>
            <Link className="nav-link icons" to="/E404">Atención al cliente</Link>
            <Link className="nav-link icons" to="/E404">Terminos y condiciones</Link>
          </article>
        </div>
      </section>
      <div>
